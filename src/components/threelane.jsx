  ...
  if (completed) {
      ...
      return(
        <div className="quodrant1">
          <div class="container">
            <div class="card img-fluid" >
              <img class="card-img-top" src="run.jpeg" alt="Card image" />
                <div class="card-img-overlay">
                  <button  className="btn btn-dark btn-sm m-2">
...
class Three extends Component {
  ...
  render() { 
    ...
    return ( 
      <div>   
        <h1 className="primary">Three Lane Traffic System</h1>            
        <button onClick={refreshPage} className="btn btn-danger btn-sm m-2">Click to Reset</button>
        <button className="btn btn-dark btn-sm m-2"> <Link to="/">Control 4 Lane Traffic</Link></button>
        <h4>Lane 1</h4>
